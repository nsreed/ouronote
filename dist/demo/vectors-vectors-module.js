...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "propertyChange$", function() { return propertyChange$; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllSettable", function() { return getAllSettable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setupAllEmitters", function() { return setupAllEmitters; });
...
const propertyChange$ = (item, property) => {
    if (!item) {
    ...
    if (item[emitterName]) {
        return item[emitterName];
    }
    const cap = property.charAt(0).toUpperCase() + property.slice(1);
    const setFnName = `set${cap}`;
    const getFnName = `get${cap}`;
    const setter = item[setFnName] ||
        ((value) => (item[propertyName] = value));
    const getter = item[getFnName] || (() => item[propertyName]);
    let priorValue;
    try {
        priorValue = item[property];
    }
    catch (e) {
        priorValue = item[propertyName];
        console.warn('%s error trying to get initial value %s', item.toString(), property, priorValue);
        throw e;
    }
    const emitter = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    item[emitterName] = emitter;
    ...
    if (priorValue) {
        item[property] = priorValue;
    }
    return item[emitterName];
};
const settable = {};
function getAllSettable(item) {
    if (!item.className) {
    ...
    return settable[item.className];
}
function setupAllEmitters(item) {
    let proto = Object.getPrototypeOf(item);
    while (proto) {
        const likelyProperties = Object.getOwnPropertyDescriptors(proto);
        const props = Object.keys(likelyProperties)
...
/***/ "4Dgj":
/*!******************************************************!*\
  !*** ./projects/demo/src/app/functions/aspect-rx.ts ***!
  \******************************************************/
/*! exports provided: returned, after$, before$ */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "returned", function() { return returned; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "after$", function() { return after$; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "before$", function() { return before$; });
/* harmony import */ var aspect_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! aspect-ts */ "7ESq");
/* harmony import */ var aspect_ts__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(aspect_ts__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "qCKp");


function returned(...args) {
    const callReturn = args[0];
    return (callReturn === null || callReturn === void 0 ? void 0 : callReturn.length) > 0 ? callReturn[callReturn.length - 1] : null;
}
function after$(context, method) {
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["fromEventPattern"])((handler) => {
        // console.log('setting up listener %s on', method, context);
        const listener = Object(aspect_ts__WEBPACK_IMPORTED_MODULE_0__["after"])(context, method, (...args) => {
            handler(...args);
        });
        const signal = {
            stop: false,
...
function before$(context, method) {
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["fromEventPattern"])((handler) => {
        const listener = Object(aspect_ts__WEBPACK_IMPORTED_MODULE_0__["before"])(context, method, (...args) => {
            handler(...args);
        });
        const signal = {
            stop: false,
...
/***/ "5jeY":
/*!*****************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/classes/PaperPair.ts ***!
  \*****************************************************************/
/*! exports provided: PaperPair */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class PaperPair {
    ...
    scope) {
        ...
        this.saveProperty$ = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
    ...
    getChild(jsonOrKey) {
        ...
        if (!this.childCache[jsonOrKey]) {
            const child = (_a = this.ctx.children) === null || _a === void 0 ? void 0 : _a.find((i) => i.data.soul === jsonOrKey);
            this.childCache[jsonOrKey] = child;
        }
        return this.childCache[jsonOrKey];
    }
    scrubJSON(json, key) {
        const scrubbed = Object.assign({}, json);
        delete scrubbed._;
    ...
    constructChild(childJSON, key) {
        ...
        this.scope.settings.insertItems = prevInsertItemsValue;
        return child;
    }
    save(properties) {
        var _a, _b;
...
/*!*****************************************************************!*\
  ...
  \*****************************************************************/
/*! exports provided: EXPECT_ARRAY, REQUIRED_BY, REQUIRES, hasRequired, MUTATION_METHODS, MUTATIONS, MUTATION_PROPERTIES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "7ESq":
/*!**********************************************!*\
  !*** ./node_modules/aspect-ts/lib/aspect.js ***!
  \**********************************************/
/*! no static exports found */
...
var tslib_1 = __webpack_require__(/*! tslib */ "mrSG");
function getAdviceRunner(context, method) {
    if (!context[method].advices) {
        var adviceRunner_1 = function () {
            var kwArgs = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                kwArgs[_i] = arguments[_i];
            }
            adviceRunner_1.advices.before.forEach(function (beforeAdvice) {
                beforeAdvice.apply(void 0, tslib_1.__spread(kwArgs));
            });
            var returnedValue;
            try {
                var stack_1 = [function () {
                        var stackArgs = [];
                        for (var _i = 0; _i < arguments.length; _i++) {
                            stackArgs[_i] = arguments[_i];
                        }
                        return adviceRunner_1.originalMethod.apply(adviceRunner_1, tslib_1.__spread(stackArgs));
                    }];
                adviceRunner_1.advices.around.forEach(function (aroundAdvice) {
                    var previous = stack_1[stack_1.length - 1];
                    stack_1.push(function () {
                        var stackArgs = [];
                        for (var _i = 0; _i < arguments.length; _i++) {
                            stackArgs[_i] = arguments[_i];
                        }
                        return aroundAdvice.apply(void 0, tslib_1.__spread(stackArgs, [previous]));
                    });
                });
                returnedValue = (stack_1.pop()).apply(void 0, tslib_1.__spread(kwArgs));
            }
            catch (error) {
                adviceRunner_1.advices.afterThrow.forEach(function (afterThrowAdvice) {
                    afterThrowAdvice.apply(void 0, tslib_1.__spread(kwArgs, [error]));
                });
                throw error;
            }
            adviceRunner_1.advices.afterReturn.forEach(function (afterReturnAdvice) {
                var newReturnedValue = afterReturnAdvice.apply(void 0, tslib_1.__spread(kwArgs, [returnedValue]));
        ...
        adviceRunner_1.advices = {
            afterReturn: [],
            afterThrow: [],
            around: [],
            before: [],
        };
        adviceRunner_1.originalMethod = context[method].bind(context);
        context[method] = adviceRunner_1;
    }
    return context[method];
}
function removeAdvice(path, advice) {
    var index = path.indexOf(advice);
    if (index === -1) {
        return false;
    }
    path.splice(index, 1);
...
function around(context, method, advice) {
    var runner = getAdviceRunner(context, method);
    runner.advices.around.push(advice);
    return function () { return removeAdvice(runner.advices.around, advice); };
}
exports.around = around;
function before(context, method, advice) {
    var runner = getAdviceRunner(context, method);
    runner.advices.before.push(advice);
    return function () { return removeAdvice(runner.advices.before, advice); };
}
exports.before = before;
function afterReturn(context, method, advice) {
    var runner = getAdviceRunner(context, method);
    runner.advices.afterReturn.push(advice);
    return function () { return removeAdvice(runner.advices.afterReturn, advice); };
}
exports.afterReturn = afterReturn;
function afterThrow(context, method, advice) {
    var runner = getAdviceRunner(context, method);
    runner.advices.afterThrow.push(advice);
    return function () { return removeAdvice(runner.advices.afterThrow, advice); };
}
exports.afterThrow = afterThrow;
function after(context, method, advice) {
    var afterReturnAdvice = afterReturn(context, method, advice);
    var afterThrowAdvice = afterThrow(context, method, advice);
    return function () { return afterReturnAdvice() && afterThrowAdvice(); };
}
exports.after = after;
...
/*!**************************************************************!*\
  ...
  \**************************************************************/
/*! exports provided: VectorsModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VectorsModule", function() { return VectorsModule; });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _vectors_routing_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vectors-routing.module */ "BACE");
/* harmony import */ var _vectors_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vectors.component */ "Dp7r");
/* harmony import */ var _paper_directive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./paper.directive */ "zEIa");
/* harmony import */ var _edit_vector_edit_vector_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit-vector/edit-vector.component */ "s/36");
/* harmony import */ var _ng_gun_src_lib_ng_gun_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../ng-gun/src/lib/ng-gun.module */ "xcn7");
/* harmony import */ var _route_vector_directive__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./route-vector.directive */ "YsgI");
/* harmony import */ var _components_layer_list_layer_list_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/layer-list/layer-list.component */ "DKW5");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _components_style_form_style_form_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/style-form/style-form.component */ "hPtE");
...
/* harmony import */ var _components_tool_directive__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./components/tool.directive */ "sRwC");
/* harmony import */ var _components_color_form_color_form_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/color-form/color-form.component */ "bN57");
/* harmony import */ var _angular_flex_layout__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! @angular/flex-layout */ "YUcS");
/* harmony import */ var _components_vector_form_vector_form_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./components/vector-form/vector-form.component */ "lNWo");
/* harmony import */ var _components_create_vector_create_vector_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./components/create-vector/create-vector.component */ "HcyG");
...
/* harmony import */ var _view_vector_view_vector_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./view-vector/view-vector.component */ "zXeL");
/* harmony import */ var _certificates_certificates_module__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ../../certificates/certificates.module */ "Rc43");
...
VectorsModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_35__["ɵɵdefineNgModule"]({ type: VectorsModule });
VectorsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_35__["ɵɵdefineInjector"]({ factory: function VectorsModule_Factory(t) { return new (t || VectorsModule)(); }, imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_35__["ɵɵsetNgModuleScope"](VectorsModule, { declarations: [_vectors_component__WEBPACK_IMPORTED_MODULE_2__["VectorsComponent"],
        _paper_directive__WEBPACK_IMPORTED_MODULE_3__["PaperDirective"],
        _edit_vector_edit_vector_component__WEBPACK_IMPORTED_MODULE_4__["EditVectorComponent"],
        _route_vector_directive__WEBPACK_IMPORTED_MODULE_6__["RouteVectorDirective"],
        _components_layer_list_layer_list_component__WEBPACK_IMPORTED_MODULE_7__["LayerListComponent"],
        _components_style_form_style_form_component__WEBPACK_IMPORTED_MODULE_9__["StyleFormComponent"],
        _components_tool_directive__WEBPACK_IMPORTED_MODULE_27__["ToolDirective"],
...
/***/ "BACE":
/*!**********************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/vectors-routing.module.ts ***!
  \**********************************************************************/
/*! exports provided: VectorsRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VectorsRoutingModule", function() { return VectorsRoutingModule; });
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _vectors_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vectors.component */ "Dp7r");
/* harmony import */ var _edit_vector_edit_vector_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit-vector/edit-vector.component */ "s/36");
/* harmony import */ var _vector_resolver__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vector.resolver */ "nHUF");
/* harmony import */ var _view_vector_view_vector_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view-vector/view-vector.component */ "zXeL");
...
const routes = [
    { path: '', component: _vectors_component__WEBPACK_IMPORTED_MODULE_1__["VectorsComponent"] },
    {
        path: ':soul',
        component: _view_vector_view_vector_component__WEBPACK_IMPORTED_MODULE_4__["ViewVectorComponent"],
        resolve: {
            soul: _vector_resolver__WEBPACK_IMPORTED_MODULE_3__["VectorResolver"],
        },
    },
    {
        path: ':soul/edit',
        component: _edit_vector_edit_vector_component__WEBPACK_IMPORTED_MODULE_2__["EditVectorComponent"],
        resolve: {
            soul: _vector_resolver__WEBPACK_IMPORTED_MODULE_3__["VectorResolver"],
        },
    },
];
class VectorsRoutingModule {
}
VectorsRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineNgModule"]({ type: VectorsRoutingModule });
VectorsRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({ factory: function VectorsRoutingModule_Factory(t) { return new (t || VectorsRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](VectorsRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] }); })();
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _edit_vector_edit_vector_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../edit-vector/edit-vector.component */ "s/36");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");



function LayerListComponent_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", layer_r1.name, " ");
} }
...
LayerListComponent.ɵfac = function LayerListComponent_Factory(t) { return new (t || LayerListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_edit_vector_edit_vector_component__WEBPACK_IMPORTED_MODULE_1__["EditVectorComponent"])); };
LayerListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LayerListComponent, selectors: [["app-layer-list"]], inputs: { layers: "layers" }, decls: 4, vars: 1, consts: [[4, "ngFor", "ngForOf"]], template: function LayerListComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "layer-list works!");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](3, LayerListComponent_div_3_Template, 2, 1, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", ctx.layers);
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJsYXllci1saXN0LmNvbXBvbmVudC5zY3NzIn0= */"] });
...
/* harmony import */ var _components_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/confirm/confirm.component */ "XXKo");
/* harmony import */ var _components_create_vector_create_vector_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/create-vector/create-vector.component */ "HcyG");
...
function VectorsComponent_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    const vector_r1 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("routerLink", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpureFunction1"](15, _c0, _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](2, 5, vector_r1)));
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate1"](" ", vector_r1.title, " ");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("routerLink", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpureFunction1"](17, _c0, _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](5, 7, vector_r1)));
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](7, 9, _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](8, 11, vector_r1)));
...
class VectorsComponent {
    constructor(vectorService, dialog) {
        ...
        this.dialog = dialog;
        this.vectors = this.vectorService.vectors
            .reduce()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])((v) => v.sort((a, b) => Object(_ng_gun_src_lib_functions_gun_utils__WEBPACK_IMPORTED_MODULE_1__["gunUpdateTime"])(b) - Object(_ng_gun_src_lib_functions_gun_utils__WEBPACK_IMPORTED_MODULE_1__["gunUpdateTime"])(a))));
    }
    ngOnInit() { }
    create() {
        this.dialog.open(_components_create_vector_create_vector_component__WEBPACK_IMPORTED_MODULE_3__["CreateVectorComponent"], { width: '90%', height: '90%' });
    ...
    remove(vector) {
        ...
        this.dialog
            .open(_components_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_2__["ConfirmComponent"])
            .afterClosed()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["filter"])((r) => r))
            .subscribe((result) => {
...
/***/ "HcyG":
/*!************************************************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/components/create-vector/create-vector.component.ts ***!
  \************************************************************************************************/
/*! exports provided: CreateVectorComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateVectorComponent", function() { return CreateVectorComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _ng_gun_src_lib_ng_sea_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../../../ng-gun/src/lib/ng-sea.service */ "mWLu");
/* harmony import */ var _vector_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../vector.service */ "w907");
...
class CreateVectorComponent {
    // recordValue$ = this.form.valueChanges.pipe(
    //   switchMap(formValue => this.vectorPair$.pipe(
    //   ))
    // )
    constructor(fb, ngGun, sea, vectorService, gunOpts, ngZone, dialog) {
        this.fb = fb;
        this.ngGun = ngGun;
        this.sea = sea;
        this.vectorService = vectorService;
        ...
        this.form = this.fb.group({
            ...
            public: false,
            title: ['untitled', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            confirm: false,
        });
        this.vectorPair$ = this.sea.pair().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["shareReplay"])(1));
        this.vectorPub$ = this.vectorPair$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["pluck"])('pub'));
    }
    ngOnInit() { }
    create() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.vectorPair$.subscribe((vectorPair) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                const vector = yield this.vectorService.create(vg, vectorPair);
                ...
                detachedGun.gun.user().auth(vectorPair, () => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                    const v = detachedGun.gun.user();
                    v.put(vector);
                    this.vectorService.vectors.set(v);
...
CreateVectorComponent.ɵfac = function CreateVectorComponent_Factory(t) { return new (t || CreateVectorComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_ng_gun_src_lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_2__["NgGunService"]), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_ng_gun_src_lib_ng_sea_service__WEBPACK_IMPORTED_MODULE_5__["NgSeaService"]), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_vector_service__WEBPACK_IMPORTED_MODULE_6__["VectorService"]), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_ng_gun_src_lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_2__["GunOptions"]), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgZone"]), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_7__["MatDialog"])); };
CreateVectorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: CreateVectorComponent, selectors: [["app-create-vector"]], decls: 17, vars: 9, consts: [["mat-dialog-title", ""], ["fxFlex", "", "mat-dialog-content", "", 3, "formGroup"], ["matInput", "", "formControlName", "title"], ["fxLayout", "column"], ["fxFlexAlign", "center end", "mat-dialog-actions", "", 3, "formGroup"], ["formControlName", "confirm"], ["mat-button", "", "color", "primary", 3, "disabled", "click"]], template: function CreateVectorComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "h1", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](1, " Create Vector\n");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](5, "Title");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelement"](6, "input", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelement"](7, "span", 3);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipe"](11, "json");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](12, "div", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](13, "mat-checkbox", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](14, "Confirm");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](15, "button", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function CreateVectorComponent_Template_button_click_15_listener() { return ctx.create(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](16, "Create");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate2"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](10, 5, ctx.vectorPub$), ": ", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](11, 7, ctx.recordValue), "  ");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("formGroup", ctx.form);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("disabled", !ctx.form.valid);
    } }, directives: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_7__["MatDialogTitle"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatusGroup"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_8__["DefaultFlexDirective"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_7__["MatDialogContent"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroupDirective"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_9__["MatFormField"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_9__["MatLabel"], _angular_material_input__WEBPACK_IMPORTED_MODULE_10__["MatInput"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControlName"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_8__["DefaultLayoutDirective"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_8__["DefaultFlexAlignDirective"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_7__["MatDialogActions"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_11__["MatCheckbox"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButton"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_13__["AsyncPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["JsonPipe"]], styles: ["[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n\npre[_ngcontent-%COMP%] {\n  font-family: monospace;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/***/ "Ipv9":
/*!*******************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/classes/ProjectPair.ts ***!
  \*******************************************************************/
/*! exports provided: ProjectPair */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class ProjectPair extends _PaperPair__WEBPACK_IMPORTED_MODULE_4__["PaperPair"] {
    constructor(chain, project, scope) {
    ...
    onLocalLayer(layer) {
        ...
        if (!l.pair) {
            ...
            const layerPair = new _ItemPair__WEBPACK_IMPORTED_MODULE_3__["ItemPair"](layerGun, layer, this.project, this.scope);
        }
    }
    setupProject() {
...
/***/ "M9g4":
/*!*********************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/tools/pen.ts ***!
  \*********************************************************/
/*! exports provided: PenTool */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "YsgI":
/*!**********************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/route-vector.directive.ts ***!
  \**********************************************************************/
/*! exports provided: RouteVectorDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RouteVectorDirective", function() { return RouteVectorDirective; });
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _vector_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vector.service */ "w907");
...
class RouteVectorDirective {
    constructor(vectorService, route, ngGun) {
        this.vectorService = vectorService;
        this.route = route;
        this.ngGun = ngGun;
        this.userPub = this.ngGun.auth().is.pub;
        this.vectorNode$ = this.route.data.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["tap"])((node) => console.log('ROUTE SOUL', node.soul)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])((data) => data.soul['#'].indexOf(this.userPub) < 0
        ...
        this.vector$ = this.vectorNode$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["switchMap"])((node) => node.on()));
        // console.log('my soul', ngGun.auth().is.pub);
    }
}
RouteVectorDirective.ɵfac = function RouteVectorDirective_Factory(t) { return new (t || RouteVectorDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_vector_service__WEBPACK_IMPORTED_MODULE_2__["VectorService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ng_gun_src_lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_4__["NgGunService"])); };
RouteVectorDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineDirective"]({ type: RouteVectorDirective, selectors: [["", "appRouteVector", ""]] });
...
/***/ "bN57":
/*!******************************************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/components/color-form/color-form.component.ts ***!
  \******************************************************************************************/
...
function ColorFormComponent_mat_form_field_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const cvp_r1 = ctx.$implicit;
    const ctx_r0 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("formControlName", cvp_r1)("min", ctx_r0.meta[cvp_r1].min)("max", ctx_r0.meta[cvp_r1].max)("step", (ctx_r0.meta[cvp_r1].max - ctx_r0.meta[cvp_r1].min) / 100);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](cvp_r1);
} }
const RE_HEX = /^\#.*/;
class ColorFormComponent {
    constructor(fb) {
        this.fb = fb;
        this.form = this.fb.group({
            red: [0, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].min(0), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].max(1)]],
            green: [0, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].min(0), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].max(1)]],
            blue: [0, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].min(0), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].max(1)]],
            hue: 0,
            saturation: [0, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].min(0), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].max(1)]],
            lightness: [0, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].min(0), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].max(1)]],
            brightness: [0, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].min(0), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].max(1)]],
            alpha: [1, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].min(0), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].max(1)]],
        });
    ...
    set color(value) {
        ...
        if (value !== this._color) {
            this._color = value;
            (_a = value.changes$) === null || _a === void 0 ? void 0 : _a.subscribe((che) => {
    ...
    ngOnInit() {
        for (const key of this.controlKeys) {
            ...
            control === null || control === void 0 ? void 0 : control.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])((v) => control.valid)).subscribe((v) => {
                // console.log('got local change %s: %f', key, control.value);
                this.color[key] = control.value;
            });
        }
    }
    updateFromColor() {
        ...
        for (const key of this.controlKeys) {
            ...
            const colorKeyValue = this.color[key];
            // console.log('  %s: %d', key, colorKeyValue);
            (_a = this.form.get(key)) === null || _a === void 0 ? void 0 : _a.patchValue(colorKeyValue, { emitEvent: false });
        }
    }
}
ColorFormComponent.ɵfac = function ColorFormComponent_Factory(t) { return new (t || ColorFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"])); };
ColorFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: ColorFormComponent, selectors: [["app-color-form"]], inputs: { color: "color" }, decls: 2, vars: 2, consts: [["gdColumns", "1fr 1fr 1fr", 3, "formGroup"], [4, "ngFor", "ngForOf"], ["matInput", "", "type", "number", 3, "formControlName", "min", "max", "step"]], template: function ColorFormComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "form", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, ColorFormComponent_mat_form_field_1_Template, 4, 5, "mat-form-field", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("formGroup", ctx.form);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngForOf", ctx.controlKeys);
    } }, directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["NgControlStatusGroup"], _angular_flex_layout_grid__WEBPACK_IMPORTED_MODULE_3__["ɵgrid_privatex"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormGroupDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormField"], _angular_material_input__WEBPACK_IMPORTED_MODULE_6__["MatInput"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["NumberValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControlName"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatLabel"]], styles: ["mat-form-field[_ngcontent-%COMP%] {\n  overflow: hidden;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/***/ "efV2":
/*!********************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/functions/decorators.ts ***!
  \********************************************************************/
...
const Property = (config) => (target, name, ...args) => {
...
/***/ "erja":
/*!**********************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/tools/move.ts ***!
  \**********************************************************/
/*! exports provided: MoveTool */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "fYSZ":
/*!*********************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/tools/pan.ts ***!
  \*********************************************************/
...
class PanTool extends _paper_tool__WEBPACK_IMPORTED_MODULE_0__["VectorTool"] {
    constructor() {
        ...
        this.dragSub = this.drag
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])((e) => e.delta.length > 0.2))
            .subscribe((e) => {
...
/***/ "hImi":
/*!************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/tools/eraser.ts ***!
  \************************************************************/
/*! exports provided: EraserTool */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "hPtE":
/*!******************************************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/components/style-form/style-form.component.ts ***!
  \******************************************************************************************/
...
class StyleFormComponent {
    ...
    set style(value) {
        ...
        this.form.controls.strokeColor.setValue(value.strokeColor.toCSS(true));
...
StyleFormComponent.ɵfac = function StyleFormComponent_Factory(t) { return new (t || StyleFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"])); };
StyleFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: StyleFormComponent, selectors: [["app-style-form"]], inputs: { style: "style" }, decls: 17, vars: 1, consts: [[3, "formGroup"], ["matInput", "", "formControlName", "strokeWidth"], ["matInput", "", "formControlName", "strokeColor"], ["matSuffix", ""], ["matInput", "", "formControlName", "fillColor"]], template: function StyleFormComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "mat-form-field");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "mat-label");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "Stroke Width");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](4, "input", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "mat-form-field");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "mat-label");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "Stroke Color");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "color_lens");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "mat-form-field");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](12, "mat-label");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, "Fill Color");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/***/ "kDHW":
/*!****************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/classes/ItemPair.ts ***!
  \****************************************************************/
/*! exports provided: ItemPair */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class ItemPair extends _PaperPair__WEBPACK_IMPORTED_MODULE_6__["PaperPair"] {
    constructor(chain, item, project, scope) {
        super(item, project, scope);
        this.chain = chain;
        this.item = item;
        this.graph$ = this.chain
            .on({ changes: true, bypassZone: true })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["debounceTime"])(25), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["shareReplay"])(1));
        ...
        this.childMap = this.children.map();
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["bufferTime"])(1000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])((children) => children.length > 0));
    ...
    doSave(json) {
        ...
        if (!json) {
            ...
            this.chain.put(Object.assign(Object.assign({}, json), { className: this.item.className }));
        }
    }
    setup() {
    ...
    onLocalChildren() {
        var _a;
        (_a = this.item.children) === null || _a === void 0 ? void 0 : _a.forEach((item) => {
...
/***/ "lNWo":
/*!********************************************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/components/vector-form/vector-form.component.ts ***!
  \********************************************************************************************/
/*! exports provided: VectorFormComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VectorFormComponent", function() { return VectorFormComponent; });
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");



class VectorFormComponent {
    constructor(fb) {
        this.fb = fb;
        this.form = this.fb.group({
...
VectorFormComponent.ɵfac = function VectorFormComponent_Factory(t) { return new (t || VectorFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"])); };
VectorFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: VectorFormComponent, selectors: [["app-vector-form"]], decls: 2, vars: 0, template: function VectorFormComponent_Template(rf, ctx) { if (rf & 1) {
...
/***/ "nHUF":
/*!***************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/vector.resolver.ts ***!
  \***************************************************************/
/*! exports provided: VectorResolver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VectorResolver", function() { return VectorResolver; });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ "qCKp");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _vector_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vector.service */ "w907");
/* harmony import */ var _ng_gun_src_lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../ng-gun/src/lib/ng-gun.service */ "bluq");
...
class VectorResolver {
    constructor(vectorService, ngGun) {
        this.vectorService = vectorService;
        this.ngGun = ngGun;
    }
    resolve(route, state) {
        return this.vectorService.vectors
            ...
            .once()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])((vector) => console.log('got vector', vector)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])((vector) => vector ? Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(vector) : this.ngGun.get(route.params.soul).once()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])((vector) => console.log('got vector', vector)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((post) => post._));
    }
}
VectorResolver.ɵfac = function VectorResolver_Factory(t) { return new (t || VectorResolver)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_vector_service__WEBPACK_IMPORTED_MODULE_3__["VectorService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_ng_gun_src_lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_4__["NgGunService"])); };
VectorResolver.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: VectorResolver, factory: VectorResolver.ɵfac, providedIn: 'root' });
...
/***/ "qI0X":
/*!*******************************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/edit-vector/converter-functions.ts ***!
  \*******************************************************************************/
/*! exports provided: bindArray, bindPaperJSON, getUUID, gunifyProject, deGunifyLoaded, deGunifyProject */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bindArray", function() { return bindArray; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bindPaperJSON", function() { return bindPaperJSON; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getUUID", function() { return getUUID; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gunifyProject", function() { return gunifyProject; });
...
function setItemSoul(item, soul) {
    if (!item.data) {
        item.data = {};
    }
    item.data[SOUL_KEY] = soul;
}
function getItemSoul(item) {
    return item.data ? item.data[SOUL_KEY] : null;
}
function getItemNode(parent, item) {
...
function isPaperObject(data) {
    return (Array.isArray(data) &&
        data.length >= 2 &&
        typeof data[0] === 'string' &&
        typeof data[1] === 'object');
}
function paperExportToObject(data) {
    const soul = getItemSoul(data[1]);
    const obj = Object.assign({ className: data[0] }, data[1]);
    // if (soul) {
    //   obj._ = {
    //     '#': soul,
    //   };
...
function bindArray(data, parent) {
    // console.log(Gun);
    ...
    switch (prevalentType) {
        ...
        case 'array':
            const boundValues = data.reduce((obj, value, index) => {
                ...
                obj[soul] = Object.assign(Object.assign({}, value), { index });
                return obj;
            }, {});
            return boundValues;
        default:
...
function bindPaperJSON(data, parent) {
    if (isPaperObject(data)) {
        ...
        const bound = data.map((e) => bindPaperJSON(e, parent));
        ...
        return Object.keys(data).reduce((target, key) => {
            const isArray = Array.isArray(data[key]);
            target[isArray ? `${ARRAY_PREFIX}${key}` : key] = bindPaperJSON(data[key], parent.get(key));
            return target;
        }, {});
    }
    else {
...
function loadNode(node, ctx) {
    return node
        .map()
        .on({ includeKeys: true })
        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["mergeMap"])((kvp) => {
        const valueOrRef = kvp[0];
        const key = kvp[1];
        console.log({ key, chain: valueOrRef });
        if (gun__WEBPACK_IMPORTED_MODULE_1__["node"].is(valueOrRef)) {
            const ref = node.get(key);
            const soul = gun__WEBPACK_IMPORTED_MODULE_1__["node"].soul(valueOrRef);
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(subKeys).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((sk) => {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(valueOrRef);
        }
    }));
}
function deGunifyLoaded(loaded, asArray = false) {
    if (asArray) {
        return Object.values(loaded).map((v) => deGunifyLoaded(v));
    }
    ...
    if (typeof loaded === 'object') {
        ...
        if (loadedKeys.includes('className')) {
            ...
            const { className } = loaded, degunned = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(loaded, ["className"]);
        ...
        for (const key in loaded) {
            ...
            if (toArray) {
                ...
                if (typeof value === 'string') {
                    ...
                    obj[arrkey] = Object.values(value).map((v) => deGunifyLoaded(v));
                }
            }
            else {
...
function deGunifyProject(node, project) {
    node
        .open()
        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["delay"])(1000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinct"])((v) => JSON.stringify(v)))
        .subscribe((loaded) => {
...
/***/ "s/36":
/*!*********************************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/edit-vector/edit-vector.component.ts ***!
  \*********************************************************************************/
/*! exports provided: EditVectorComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditVectorComponent", function() { return EditVectorComponent; });
/* harmony import */ var paper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! paper */ "IiLU");
/* harmony import */ var paper__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(paper__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
/* harmony import */ var _classes_ProjectPair__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../classes/ProjectPair */ "Ipv9");
/* harmony import */ var _route_vector_directive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../route-vector.directive */ "YsgI");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _vector_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../vector.service */ "w907");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _ng_gun_src_lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../../ng-gun/src/lib/ng-gun.service */ "bluq");
...
/* harmony import */ var _ng_gun_src_lib_chain_directive__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../../../ng-gun/src/lib/chain.directive */ "R39e");
...
/* harmony import */ var _paper_directive__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../paper.directive */ "zEIa");
...
/* harmony import */ var _components_tool_directive__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../components/tool.directive */ "sRwC");
/* harmony import */ var _components_color_form_color_form_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../components/color-form/color-form.component */ "bN57");
...
function EditVectorComponent_mat_accordion_3_ng_template_4_mat_button_toggle_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "mat-button-toggle", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function EditVectorComponent_mat_accordion_3_ng_template_4_mat_button_toggle_1_Template_mat_button_toggle_click_0_listener() { const tool_r8 = ctx.$implicit; return tool_r8.activate(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("checked", tool_r8 === _r3.scope.tool)("value", tool_r8)("appTool", tool_r8);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"](" ", tool_r8.name, " ");
} }
function EditVectorComponent_mat_accordion_3_ng_template_4_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "div", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](1, EditVectorComponent_mat_accordion_3_ng_template_4_mat_button_toggle_1_Template, 2, 4, "mat-button-toggle", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
} if (rf & 2) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](2);
    const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵreference"](7);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngForOf", _r3.scope.tools);
} }
function EditVectorComponent_mat_accordion_3_ng_template_8_div_0_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "div", 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](1, "app-color-form", 16);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
} if (rf & 2) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](3);
    const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵreference"](7);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("appTool", _r3.scope.tool);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("color", _r3.project.currentStyle.strokeColor);
} }
function EditVectorComponent_mat_accordion_3_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](0, EditVectorComponent_mat_accordion_3_ng_template_8_div_0_Template, 2, 2, "div", 14);
} if (rf & 2) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](2);
    const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵreference"](7);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngIf", _r3.scope.tool);
} }
const _c2 = function (a0) { return { active: a0 }; };
function EditVectorComponent_mat_accordion_3_ng_template_12_mat_list_item_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "mat-list-item", 19);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function EditVectorComponent_mat_accordion_3_ng_template_12_mat_list_item_1_Template_mat_list_item_click_0_listener() { const layer_r12 = ctx.$implicit; return layer_r12.activate(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
} if (rf & 2) {
    const layer_r12 = ctx.$implicit;
    const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction1"](4, _c2, layer_r12 === ctx_r11.project.activeLayer));
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate3"](" ", layer_r12.toString(), " ", layer_r12 === ctx_r11.project.activeLayer ? "*" : "", " ", layer_r12.children == null ? null : layer_r12.children.length, " ");
} }
function EditVectorComponent_mat_accordion_3_ng_template_12_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "mat-action-list", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](1, EditVectorComponent_mat_accordion_3_ng_template_12_mat_list_item_1_Template, 2, 6, "mat-list-item", 18);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
} if (rf & 2) {
    const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngForOf", ctx_r6.project == null ? null : ctx_r6.project.layers);
} }
function EditVectorComponent_mat_accordion_3_Template(rf, ctx) { if (rf & 1) {
    const _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "mat-accordion", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](1, "mat-expansion-panel", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](2, "mat-expansion-panel-header");
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](3, "Tools");
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](4, EditVectorComponent_mat_accordion_3_ng_template_4_Template, 2, 1, "ng-template", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](5, "mat-expansion-panel", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](6, "mat-expansion-panel-header");
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](7, "Color");
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](8, EditVectorComponent_mat_accordion_3_ng_template_8_Template, 1, 1, "ng-template", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](9, "mat-expansion-panel", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](10, "mat-expansion-panel-header");
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](11, "Layers");
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](12, EditVectorComponent_mat_accordion_3_ng_template_12_Template, 2, 1, "ng-template", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](13, "mat-action-row");
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](14, "a", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function EditVectorComponent_mat_accordion_3_Template_a_click_14_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r15); const ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](); return ctx_r14.addLayer(); });
...
class EditVectorComponent extends _route_vector_directive__WEBPACK_IMPORTED_MODULE_3__["RouteVectorDirective"] {
    ...
    ngAfterViewInit() {
        this.vectorNode$.subscribe((node) => {
            ...
            //     // this.paperDirective.project.activate();
            //   });
            this.onProjectReady(this.paperDirective.project, node);
            node
                .get('title')
                .on()
                .subscribe((title) => {
                ...
                (_a = this.vectorForm.get('title')) === null || _a === void 0 ? void 0 : _a.patchValue(title, { emitEvent: false });
            });
            (_a = this.vectorForm
                .get('title')) === null || _a === void 0 ? void 0 : _a.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["distinct"])()).subscribe((title) => {
                console.log('local title change', title);
                node.get('title').put(title);
            });
        });
        this.vector$.subscribe((vector) => {
    ...
    onProjectReady(project, gun) {
        ...
        const paperChain = new _classes_ProjectPair__WEBPACK_IMPORTED_MODULE_2__["ProjectPair"](gun, this.paperDirective.project, this.paperDirective.scope);
    }
    addLayer() {
...
EditVectorComponent.ɵfac = function EditVectorComponent_Factory(t) { return new (t || EditVectorComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_vector_service__WEBPACK_IMPORTED_MODULE_6__["VectorService"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_5__["NgZone"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_ng_gun_src_lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_8__["NgGunService"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_9__["DomSanitizer"])); };
EditVectorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({ type: EditVectorComponent, selectors: [["ng-component"]], viewQuery: function EditVectorComponent_Query(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵviewQuery"](_c0, 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵviewQuery"](_c1, 1);
    } if (rf & 2) {
        let _t;
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵloadQuery"]()) && (ctx.paperDirective = _t.first);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵloadQuery"]()) && (ctx.preview = _t.first);
    } }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵInheritDefinitionFeature"]], decls: 8, vars: 4, consts: [[3, "gunChain"], ["vectorChain", "gunChain"], ["multi", "", "dense", "", "displayMode", "flat", "fxLayout", "column", "fxFlex", "0 1 175px", 4, "ngIf"], ["fxFlex", "1 1 auto", "fxLayout", "row", "fxLayoutAlign", "stretch stretch", "id", "CanvasContainer"], ["Container", ""], ["id", "Workspace", "appPaper", ""], ["paper", "appPaper"], ["multi", "", "dense", "", "displayMode", "flat", "fxLayout", "column", "fxFlex", "0 1 175px"], ["expanded", ""], ["matExpansionPanelContent", ""], ["mat-icon-button", "", 3, "click"], ["matButtonToggleGroup", "", 1, "column"], [3, "checked", "value", "appTool", "click", 4, "ngFor", "ngForOf"], [3, "checked", "value", "appTool", "click"], [3, "appTool", 4, "ngIf"], [3, "appTool"], [3, "color"], ["dense", ""], [3, "ngClass", "click", 4, "ngFor", "ngForOf"], [3, "ngClass", "click"]], template: function EditVectorComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementContainerStart"](0, 0, 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipe"](2, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](3, EditVectorComponent_mat_accordion_3_Template, 17, 0, "mat-accordion", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](4, "div", 3, 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](6, "canvas", 5, 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementContainerEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("gunChain", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind1"](2, 2, ctx.vectorNode$));
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngIf", ctx.project);
    } }, directives: [_ng_gun_src_lib_chain_directive__WEBPACK_IMPORTED_MODULE_10__["ChainDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["NgIf"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_12__["DefaultFlexDirective"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_12__["DefaultLayoutDirective"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_12__["DefaultLayoutAlignDirective"], _paper_directive__WEBPACK_IMPORTED_MODULE_13__["PaperDirective"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__["MatAccordion"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__["MatExpansionPanel"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__["MatExpansionPanelHeader"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__["MatExpansionPanelContent"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__["MatExpansionPanelActionRow"], _angular_material_button__WEBPACK_IMPORTED_MODULE_15__["MatAnchor"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_16__["MatIcon"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["NgForOf"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_17__["MatButtonToggle"], _components_tool_directive__WEBPACK_IMPORTED_MODULE_18__["ToolDirective"], _components_color_form_color_form_component__WEBPACK_IMPORTED_MODULE_19__["ColorFormComponent"], _angular_material_list__WEBPACK_IMPORTED_MODULE_20__["MatList"], _angular_material_list__WEBPACK_IMPORTED_MODULE_20__["MatListItem"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["NgClass"], _angular_flex_layout_extended__WEBPACK_IMPORTED_MODULE_21__["DefaultClassDirective"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_11__["AsyncPipe"]], styles: ["[_nghost-%COMP%] {\n  height: 100%;\n  display: flex;\n  flex-direction: row;\n}\n\n#CanvasContainer[_ngcontent-%COMP%] {\n  overflow: hidden;\n}\n\ncanvas#Workspace[_ngcontent-%COMP%] {\n  outline: solid 10px gray;\n}\n\nmat-accordion[_ngcontent-%COMP%] {\n  overflow: hidden;\n}\n\nmat-accordion[_ngcontent-%COMP%]:last-child {\n  flex-grow: 1;\n}\n\nform[_ngcontent-%COMP%] {\n  padding: 0;\n  margin: 0;\n}\n\nmat-list-item.active[_ngcontent-%COMP%] {\n  white-space: nowrap;\n  break-inside: avoid;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  outline: solid 3px #0000ff55;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/***/ "sRwC":
/*!*************************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/components/tool.directive.ts ***!
  \*************************************************************************/
/*! exports provided: ToolDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ToolDirective", function() { return ToolDirective; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");

class ToolDirective {
    constructor() { }
}
ToolDirective.ɵfac = function ToolDirective_Factory(t) { return new (t || ToolDirective)(); };
ToolDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({ type: ToolDirective, selectors: [["", "appTool", ""]], inputs: { tool: ["appTool", "tool"] } });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/ng-gun.service */ "bluq");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GunOptions", function() { return _lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_0__["GunOptions"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NgGunService", function() { return _lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_0__["NgGunService"]; });

/* harmony import */ var _lib_ng_gun_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/ng-gun.component */ "kwtq");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NgGunComponent", function() { return _lib_ng_gun_component__WEBPACK_IMPORTED_MODULE_1__["NgGunComponent"]; });

/* harmony import */ var _lib_ng_gun_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/ng-gun.module */ "xcn7");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NgGunModule", function() { return _lib_ng_gun_module__WEBPACK_IMPORTED_MODULE_2__["NgGunModule"]; });

/* harmony import */ var _lib_classes_GunChain__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/classes/GunChain */ "tg88");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GUN_NODE", function() { return _lib_classes_GunChain__WEBPACK_IMPORTED_MODULE_3__["GUN_NODE"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GunChain", function() { return _lib_classes_GunChain__WEBPACK_IMPORTED_MODULE_3__["GunChain"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GunAuthChain", function() { return _lib_classes_GunChain__WEBPACK_IMPORTED_MODULE_3__["GunAuthChain"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GunCertChain", function() { return _lib_classes_GunChain__WEBPACK_IMPORTED_MODULE_3__["GunCertChain"]; });

/* harmony import */ var _lib_soul_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lib/soul.pipe */ "FlTl");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SoulPipe", function() { return _lib_soul_pipe__WEBPACK_IMPORTED_MODULE_4__["SoulPipe"]; });

/* harmony import */ var _lib_updated_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lib/updated.pipe */ "xdc7");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UpdatedPipe", function() { return _lib_updated_pipe__WEBPACK_IMPORTED_MODULE_5__["UpdatedPipe"]; });

/* harmony import */ var _lib_chain_directive__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./lib/chain.directive */ "R39e");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ChainDirective", function() { return _lib_chain_directive__WEBPACK_IMPORTED_MODULE_6__["ChainDirective"]; });

/* harmony import */ var _lib_alias_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lib/alias.pipe */ "foKA");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AliasPipe", function() { return _lib_alias_pipe__WEBPACK_IMPORTED_MODULE_7__["AliasPipe"]; });

/* harmony import */ var _lib_verify_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./lib/verify.pipe */ "VUWm");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "VerifyPipe", function() { return _lib_verify_pipe__WEBPACK_IMPORTED_MODULE_8__["VerifyPipe"]; });
...
/***/ "w907":
/*!**************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/vector.service.ts ***!
  \**************************************************************/
/*! exports provided: VectorService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class VectorService {
    constructor(userService, ngGun, gunOpts, ngZone, sea) {
        this.userService = userService;
        this.ngGun = ngGun;
        this.gunOpts = gunOpts;
        this.ngZone = ngZone;
        this.sea = sea;
        this.vectors = this.userService.user.get('vectors');
    }
    certify(certificant, paths, auth) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
    ...
    create(value, vectorPair) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const certs = yield this.certify(userPair, ['layers', 'title'], vectorPair);
            const vector = Object.assign(Object.assign({}, value), { owner: {}, certs });
            const vectorPairEnc = yield gun__WEBPACK_IMPORTED_MODULE_1__["SEA"].encrypt(vectorPair, userPair);
            vector.owner[userPair.pub] = vectorPairEnc;
            return vector;
        });
    }
}
VectorService.ɵfac = function VectorService_Factory(t) { return new (t || VectorService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_ng_gun_src_lib_ng_gun_service__WEBPACK_IMPORTED_MODULE_4__["NgGunService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"]('gun-options'), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgZone"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_ng_gun_src_lib_ng_sea_service__WEBPACK_IMPORTED_MODULE_5__["NgSeaService"])); };
VectorService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: VectorService, factory: VectorService.ɵfac, providedIn: 'root' });
...
/*!***************************************************************!*\
  ...
  \***************************************************************/
/*! exports provided: PaperDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PaperDirective", function() { return PaperDirective; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var paper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! paper */ "IiLU");
/* harmony import */ var paper__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(paper__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "qCKp");
...
class PaperDirective {
    ...
    ignore(fn, ...args) {
        ...
        try {
            ...
            if (item) {
                if (fn.name === 'Layer') {
                    item.insertAbove(this.project.activeLayer);
                }
                else {
    ...
    ngOnInit() {
        ...
        this.project.currentStyle = new this.scope.Style({});
        this.project.currentStyle.strokeColor = new this.scope.Color(0, 0, 0);
        this.project.currentStyle.strokeWidth = 5;
        // update the view size after a delay to account for UI loading time
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(1000).subscribe(() => this.updateViewSize());
        this.resize$.subscribe(() => {
            console.log('PROJECT CANVAS RESIZE');
        });
        // CREATE BACKGROUND LAYER
        this.scope.settings.insertItems = false;
        this.backgroundLayer = new paper__WEBPACK_IMPORTED_MODULE_1__["Layer"]();
        this.backgroundLayer.data.ignore = true;
        this.backgroundLayer.name = 'background';
        this.project.insertLayer(0, this.backgroundLayer);
        this.scope.settings.insertItems = true;
    }
    updateViewSize() {
        var _a, _b;
        ...
        this.project.view.viewSize.width =
            ((_a = this.project.view.element.parentElement) === null || _a === void 0 ? void 0 : _a.scrollWidth) ||
                this.project.view.element.scrollWidth;
        this.project.view.viewSize.height =
            ((_b = this.project.view.element.parentElement) === null || _b === void 0 ? void 0 : _b.scrollHeight) ||
...
/***/ "zXeL":
/*!*********************************************************************************!*\
  !*** ./projects/demo/src/app/user/vectors/view-vector/view-vector.component.ts ***!
  \*********************************************************************************/
/*! exports provided: ViewVectorComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewVectorComponent", function() { return ViewVectorComponent; });
/* harmony import */ var _route_vector_directive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../route-vector.directive */ "YsgI");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _vector_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../vector.service */ "w907");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var projects_ng_gun_src_public_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! projects/ng-gun/src/public-api */ "uXa4");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/platform-browser */ "jhN1");
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../user.service */ "DlYp");
...
/* harmony import */ var _certificates_certificates_certificates_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../certificates/certificates/certificates.component */ "MzpB");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common */ "ofXK");
...
class ViewVectorComponent extends _route_vector_directive__WEBPACK_IMPORTED_MODULE_0__["RouteVectorDirective"] {
    constructor(vectorService, route, ngZone, fb, ngGun, sanitizer, userService) {
        super(vectorService, route, ngGun);
        this.ngZone = ngZone;
        this.fb = fb;
        this.sanitizer = sanitizer;
...
ViewVectorComponent.ɵfac = function ViewVectorComponent_Factory(t) { return new (t || ViewVectorComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_vector_service__WEBPACK_IMPORTED_MODULE_2__["VectorService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](projects_ng_gun_src_public_api__WEBPACK_IMPORTED_MODULE_5__["NgGunService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_6__["DomSanitizer"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"])); };
ViewVectorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ViewVectorComponent, selectors: [["ng-component"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 4, vars: 3, consts: [[3, "gunChain"], ["vector", "gunChain"]], template: function ViewVectorComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0, 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipe"](2, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](3, "app-certificates");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("gunChain", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](2, 1, ctx.vectorNode$));
    } }, directives: [_ng_gun_src_lib_chain_directive__WEBPACK_IMPORTED_MODULE_8__["ChainDirective"], _certificates_certificates_certificates_component__WEBPACK_IMPORTED_MODULE_9__["CertificatesComponent"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_10__["AsyncPipe"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ2aWV3LXZlY3Rvci5jb21wb25lbnQuc2NzcyJ9 */"] });


/***/ })

}]);
//# sourceMappingURL=vectors-vectors-module.js.map